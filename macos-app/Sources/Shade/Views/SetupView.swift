    ...
    private let steps: [Step] = [
        ...
        .init(
            ...
            body:
                ...
                Click Deploy. Google may ask you to authorize the script the first \
                time — review the permissions and continue.
                """
        ),
        .init(
 ...
 *   5. Copy the Deployment ID into Shade as the Script ID.
 *
